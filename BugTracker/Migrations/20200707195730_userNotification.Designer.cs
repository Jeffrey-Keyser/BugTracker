...
namespace BugTracker.Migrations
{
    ...
    [Migration("20200707195730_userNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugTracker.Models.UserNotification", b =>
                {
                    ...
                    b.Property<string>("NotificationAuthorId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("AffectedId", "AuthorId");

                    b.HasIndex("AffectedUserId");

                    b.HasIndex("NotificationAuthorId");
            ...
            modelBuilder.Entity("BugTracker.Models.UserNotification", b =>
                {
                    b.HasOne("BugTracker.Areas.Identity.Data.BugTrackerUser", "AffectedUser")
                        .WithMany()
                        .HasForeignKey("AffectedUserId");

                    b.HasOne("BugTracker.Areas.Identity.Data.BugTrackerUser", "NotificationAuthor")
                        .WithMany()
                        .HasForeignKey("NotificationAuthorId");
                });

            modelBuilder.Entity("BugTracker.Models.UserProject", b =>
                {
                    b.HasOne("BugTracker.Areas.Identity.Data.BugTrackerUser", "BugTrackerUser")
